...
sudo yarn dev shelley address key-gen \
...
utxoSend=$(expr ${utxoSend} + 2000000)  # deposit return
...
echo "[cardano-cli] Create key deregistration cert"
...
sudo yarn dev shelley transaction sign \
--tx-body-file tx.raw \
--hw-signing-file payment.hwsfile \
--hw-signing-file stake.hwsfile \
--mainnet \
